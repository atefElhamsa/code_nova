...
/* ── Modules Data ────────────────────────────────────────── */
const modules = [
  {n:1,  ar:'الأساسيات والإعداد',        en:'Basics & Setup',           color:'#f97316', lessons:2, link:'/docs-cpp/module1-basics/intro-and-setup',                      chips:['Setup','Variables','Operators']},
  {n:2,  ar:'التحكم في مسار البرنامج',   en:'Control Flow',             color:'#fb923c', lessons:2, link:'/docs-cpp/module2-control-flow/conditions',                    chips:['if/else','Loops','Switch']},
  {n:3,  ar:'الدوال',                    en:'Functions',                color:'#f59e0b', lessons:2, link:'/docs-cpp/module3-functions/functions-basics',                  chips:['Functions','Recursion','Overloading']},
  {n:4,  ar:'المصفوفات والنصوص',         en:'Arrays & Strings',         color:'#eab308', lessons:2, link:'/docs-cpp/module4-arrays-strings/arrays',                      chips:['Arrays','Vectors','Strings']},
  {n:5,  ar:'المؤشرات وإدارة الذاكرة',  en:'Pointers & Memory',        color:'#a78bfa', lessons:2, link:'/docs-cpp/module5-pointers-memory/pointers-basics',            chips:['Pointers','new/delete','Stack vs Heap']},
  {n:6,  ar:'البرمجة الكائنية',          en:'OOP in C++',               color:'#6366f1', lessons:3, link:'/docs-cpp/module6-oop/classes-objects',                        chips:['Classes','Inheritance','Polymorphism']},
  {n:7,  ar:'OOP متقدم',                 en:'Advanced OOP',             color:'#8b5cf6', lessons:2, link:'/docs-cpp/module7-advanced-oop/operator-overloading',          chips:['Operator Overloading','Templates']},
  {n:8,  ar:'مكتبة القوالب القياسية',   en:'STL',                      color:'#06b6d4', lessons:2, link:'/docs-cpp/module8-stl/containers',                             chips:['vector','map','set','Algorithms']},
  {n:9,  ar:'الأخطاء والملفات',          en:'Errors & File Handling',   color:'#22d3ee', lessons:2, link:'/docs-cpp/module9-errors-files/exceptions',                   chips:['try/catch','throw','fstream']},
  {n:10, ar:'المشروع النهائي',           en:'Capstone Project',         color:'#34d399', lessons:1, link:'/docs-cpp/module10-capstone/library-system-project',          chips:['Library System','OOP','STL','Files']},
];

/* ── Page ────────────────────────────────────────────────── */
export default function CppCourse(): JSX.Element {
  useScrollReveal();
  const heroRef = useRef<HTMLElement>(null);
  useMouseGlow(heroRef);

  return (
    <Layout title="C++ Course — CodeNova" description="Master C++ from basics to OOP, STL, and Memory Management">
      <div className="cpp-page">
        ...
        <section className="hero-section" ref={heroRef}>
          ...
          <div className="hero-content">
            <div className="hero-badge reveal-on-scroll">
              ...
              <span className="badge-text" dir="ltr">Systems Programming · لغة الأنظمة</span>
            </div>

            <h1 className="hero-title reveal-on-scroll" style={{animationDelay:'0.15s'}} dir="ltr">
              Master <span className="text-gradient">C++</span>
            </h1>
            <h2 className="hero-subtitle reveal-on-scroll" style={{animationDelay:'0.25s'}}>
              <span dir="ltr">From Zero to OOP, STL & Memory Management</span>
              <span dir="rtl" style={{display:'block', marginTop:'8px', fontSize:'0.7em', opacity:0.7}}>من الأساسيات إلى البرمجة الكائنية ومكتبة القوالب وإدارة الذاكرة</span>
            </h2>

            <p className="hero-description reveal-on-scroll" style={{animationDelay:'0.35s'}}>
              <span dir="ltr" style={{display:'block', marginBottom:'10px'}}>The definitive C++ course: build a rock-solid foundation, write efficient code, and understand exactly how computers manage memory.</span>
              <span dir="rtl" style={{display:'block', color:'#94a3b8', fontSize:'0.9em'}}>الكورس الأشمل للغة C++: أسس قوية، كود ذو أداء عالٍ، وفهم حقيقي لكيفية إدارة الكومبيوتر للذاكرة.</span>
            </p>

            <div className="hero-tech reveal-on-scroll" style={{animationDelay:'0.45s'}}>
              {['C++17','OOP','STL','Pointers','Templates','Memory','Exceptions','File I/O'].map((t,i) => (
                <div key={t} style={{animation:`float ${3+(i%3)}s ease-in-out infinite alternate`, animationDelay:`${i*0.1}s`}}>
                  <TechChip label={t} color={i%2===0 ? '#f97316' : '#a78bfa'} />
                </div>
              ))}
            </div>

            <div className="hero-cta reveal-on-scroll" style={{animationDelay:'0.55s'}}>
              <Link to="/docs-cpp/module1-basics/intro-and-setup" className="btn btn-primary btn-glow" dir="ltr">
                <span className="btn-icon">⚡</span> Start Learning <span style={{opacity:0.5, margin:'0 8px'}}>|</span> <span dir="rtl">ابدأ التعلم</span>
              </Link>
              <Link to="/docs-cpp/module6-oop/classes-objects" className="btn btn-secondary" dir="ltr">
        ...
        <section className="stats-section">
          <div className="stats-grid">
            {[
              ...
              {n:1,  suffix:'', labelEn:'Capstone Project', labelAr:'مشروع نهائي'},
        ...
        <section className="curriculum-section">
          <div className="section-header reveal-on-scroll">
            ...
            <span className="section-subtitle">20 درساً في 10 وحدات — من الأساسيات للمشروع الكامل</span>
          </div>

          <div className="parts-grid">
            {modules.map((m,i) => {
              const rgbMap: Record<string,string> = {
                '#f97316':'249,115,22','#fb923c':'251,146,60','#f59e0b':'245,158,11',
                '#eab308':'234,179,8','#a78bfa':'167,139,250','#6366f1':'99,102,241',
                '#8b5cf6':'139,92,246','#06b6d4':'6,182,212','#22d3ee':'34,211,238','#34d399':'52,211,153'
              };
              const rgb = rgbMap[m.color] ?? '249,115,22';
              return (
        ...
        <div className="final-cta reveal-on-scroll">
          ...
          <h2 className="cta-title" dir="ltr">
            Ready to Master C++?
            <span className="cta-subtitle" dir="rtl">مستعد تتعلم C++ من الصفر للاحتراف؟</span>
          </h2>
          <p className="cta-desc">
            <span dir="ltr" style={{display:'block'}}>20 lessons · OOP + STL + Memory Management · Capstone Project</span>
            <span dir="rtl" style={{display:'block', marginTop:'6px'}}>20 درساً · OOP + STL + إدارة الذاكرة · مشروع نهائي</span>
          </p>
          <Link to="/docs-cpp/module1-basics/intro-and-setup" className="btn btn-primary btn-large btn-glow" dir="ltr">
      ...
      <style>{`
        :root {
          ...
          --cpp-color: #f97316;
          --cpp-glow: rgba(249,115,22,0.4);
        }

        .cpp-page { background-color: var(--color-bg); color: #fff; font-family: 'Inter', system-ui, sans-serif; min-height: 100vh; }
        ...
        .reveal-on-scroll.is-revealed { opacity:1; visibility:visible; }
        .reveal-on-scroll { transition: all 0.8s cubic-bezier(0.16,1,0.3,1); transform: translateY(30px); }
        .reveal-on-scroll.is-revealed { transform: translateY(0); }
        ...
        /* Hero */
        .hero-section {
          position: relative; overflow: hidden; min-height: 95vh;
        ...
        .mouse-glow { position:absolute; inset:0; background:radial-gradient(circle at var(--mouse-x,50%) var(--mouse-y,50%), rgba(249,115,22,0.06) 0%, transparent 45%); pointer-events:none; z-index:1; }
        ...
        .glow-1 { top:-10%; left:-10%; width:55vw; height:55vw; background:rgba(249,115,22,0.15); }
        .glow-2 { bottom:-10%; right:-10%; width:50vw; height:50vw; background:rgba(167,139,250,0.12); animation-delay:-5s; }
        .particle { position:absolute; border-radius:50%; background:#f97316; box-shadow:0 0 12px rgba(249,115,22,0.6); animation:float linear infinite alternate; z-index:1; }
        ...
        .hero-badge { display:inline-flex; align-items:center; gap:0.75rem; background:rgba(249,115,22,0.1); border:1px solid rgba(249,115,22,0.3); border-radius:30px; padding:0.5rem 1.5rem; margin-bottom:2.5rem; }
        .badge-dot { width:8px; height:8px; border-radius:50%; background:#f97316; box-shadow:0 0 10px #f97316; animation:pulseGlow 2s ease-in-out infinite; }
        .badge-text { font-size:0.9rem; font-weight:700; color:#fdba74; }

        .hero-title { font-size:clamp(3.5rem,8vw,6.5rem); font-weight:900; margin:0 0 1rem; color:#fff; letter-spacing:-1px; }
        .text-gradient { background:linear-gradient(135deg,#f97316,#fb923c,#fbbf24); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
        ...
        .btn-primary { background:linear-gradient(135deg,#f97316,#ea580c); color:#fff !important; box-shadow:0 10px 25px rgba(249,115,22,0.35); border:1px solid rgba(255,255,255,0.1); }
        .btn-primary:hover { transform:translateY(-3px) scale(1.02); box-shadow:0 15px 35px rgba(249,115,22,0.5); }
        ...
        .btn-secondary:hover { transform:translateY(-3px) scale(1.02); border-color:rgba(249,115,22,0.4); box-shadow:0 10px 25px rgba(0,0,0,0.3); }
        ...
        .stat-number { font-size:clamp(3rem,6vw,4.5rem); font-weight:900; background:linear-gradient(135deg,#fff 20%,#f97316 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent; margin-bottom:0.5rem; line-height:1; }
        .stat-label-en { font-size:0.9rem; font-weight:800; color:#f97316; letter-spacing:1px; text-transform:uppercase; margin-bottom:6px; }
        ...
        .section-badge { display:inline-block; padding:6px 16px; border-radius:20px; background:rgba(249,115,22,0.1); color:#f97316; font-weight:700; letter-spacing:2px; text-transform:uppercase; margin-bottom:1rem; }
        ...
        /* Final CTA */
        .final-cta { position:relative; text-align:center; padding:8rem 2rem; background:linear-gradient(180deg,transparent,rgba(249,115,22,0.05),transparent); border-top:1px solid rgba(249,115,22,0.15); border-bottom:1px solid rgba(249,115,22,0.15); overflow:hidden; }
        .cta-bg-glow { position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); width:600px; height:300px; background:radial-gradient(ellipse,rgba(249,115,22,0.2),transparent 70%); pointer-events:none; }
        ...
        .cta-desc { font-size:1.1rem; color:#64748b; margin:0 auto 3rem; max-width:550px; line-height:1.8; position:relative; }
